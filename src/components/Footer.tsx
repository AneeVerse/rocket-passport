      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="relative mb-12">
          ...
          <div className="flex space-x-4 sm:space-x-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/tigerterrain.in" target="_blank" rel="noopener noreferrer" className="group">
                <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm border border-white/20 shadow-lg transition-all group-hover:bg-white/15 group-hover:scale-105 text-white">
              ...
              {/* Email */}
              <a href="mailto:team.tigerterrain@gmail.com" target="_blank" rel="noopener noreferrer" className="group">
                <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm border border-white/20 shadow-lg transition-all group-hover:bg-white/15 group-hover:scale-105 text-white">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Phone */}
              <a href="tel:+917021015803" target="_blank" rel="noopener noreferrer" className="group">
                <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm border border-white/20 shadow-lg transition-all group-hover:bg-white/15 group-hover:scale-105 text-white">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/917021015803" target="_blank" rel="noopener noreferrer" className="group">
                <div className="rounded-xl bg-white/10 p-3 backdrop-blur-sm border border-white/20 shadow-lg transition-all group-hover:bg-white/15 group-hover:scale-105 text-white">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-white/20 pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              <span className="text-sm text-white/90">© 2025 Rocket Singh Enterprises. All rights reserved.</span>
            </div>

            {/* Center - Privacy Policy and Terms of Service */}
            <div className="flex items-center justify-center space-x-4 sm:space-x-6 text-sm text-white/90 order-3 lg:order-2">
            ...
            <div className="text-center lg:text-right order-1 lg:order-3">
              <a 
                ...
                className="flex items-center justify-center lg:justify-end space-x-2 text-sm text-white/90 hover:text-white transition-colors duration-200 group"
              >
