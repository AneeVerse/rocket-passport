...
export default function Footer() {
  return (
    <footer className="w-full bg-[#027b7a] text-white pt-12 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center space-x-4">
                ...
                <h3 className="text-4xl font-bold text-white leading-tight">
                  Get Your Passport Without The Hassles
                </h3>
              </div>
              ...
              <div>
                <p className="text-white text-[15px] leading-relaxed ">
                  Join 100,000+ satisfied customers who got their passports with professional assistance and guaranteed approval.
          ...
          <div className="flex space-x-4 sm:space-x-6">
              {/* Instagram */}
              <a href="https://www.instagram.com/tigerterrain.in" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ecf7ff] transition-colors duration-200 p-2 hover:bg-[#026968] rounded-full">
              ...
              {/* Email */}
              <a href="mailto:team.tigerterrain@gmail.com" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ecf7ff] transition-colors duration-200 p-2 hover:bg-[#026968] rounded-full">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* Phone */}
              <a href="tel:+917021015803" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ecf7ff] transition-colors duration-200 p-2 hover:bg-[#026968] rounded-full">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* WhatsApp */}
              <a href="https://wa.me/917021015803" target="_blank" rel="noopener noreferrer" className="text-white hover:text-[#ecf7ff] transition-colors duration-200 p-2 hover:bg-[#026968] rounded-full">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* Bottom Section */}
        <div className="border-t border-[#026968] pt-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            
            {/* Left Side - Copyright */}
            <div className="text-center lg:text-left order-2 lg:order-1">
              <span className="text-sm text-white">© 2025 Rocket Singh Enterprises. All rights reserved.</span>
            </div>

            {/* Center - Privacy Policy and Terms of Service */}
            <div className="flex items-center justify-center space-x-4 sm:space-x-6 text-sm text-white order-3 lg:order-2">
            ...
            <div className="text-center lg:text-right order-1 lg:order-3">
              <a 
                ...
                className="flex items-center justify-center lg:justify-end space-x-2 text-sm text-white hover:text-white transition-colors duration-200 group"
              >
